...
var ResponsiveHeader = function ResponsiveHeader(props) {
  var _useState = React.useState(''),
      kw = _useState[0],
      setKW = _useState[1];

  React.useEffect(function () {
    var menuBtn = document.querySelector('.dnarn .menu-icon');
    var searchBtn = document.querySelector('.dnarn .search-icon');
    var cancelBtn = document.querySelector('.dnarn .cancel-icon');
    var items = document.querySelector('.dnarn .nav-items');
    var form = document.querySelector('.dnarn form');
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    className: "dnarn"
  }, /*#__PURE__*/React__default.createElement("nav", null, /*#__PURE__*/React__default.createElement("div", {
    className: "menu-icon"
    ...
    name: "close"
  })), props.handleSearch && /*#__PURE__*/React__default.createElement("form", {
    onSubmit: handleFormSubmit
  }, /*#__PURE__*/React__default.createElement(semanticUiReact.Input, {
    icon: /*#__PURE__*/React__default.createElement(semanticUiReact.Icon, {
      name: "search",
      link: true,
